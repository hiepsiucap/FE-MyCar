      ...
      <Link to={`/car/${c.carId}`}>
        ...
        >
          ...
          <div className="px-4 py-2 border-b-2 border-gray-100">
            <p className=" font-bold text-start font-manrope">
              {" "}
              {c.brand} {c.model} {c.year}
            </p>
            <p className=" text-sm text-gray-600 text-start font-manrope">
            ...
            <div className="flex justify-between">
              ...
              <div className=" flex flex-col items-end space-y-2">
                <p className=" font-manrope text-gray-600 line-through">
                  {formatPrice(c.cost * 2)}
                </p>
                <p className=" font-manrope text-2xl font-bold text-primary">
                  {formatPrice(c.cost)}
                </p>
          ...
          <div className=" flex justify-between px-4 py-2 ">
            ...
            <div className=" flex-col space-y-1 items-center">
              ...
              <p className="text-sm">
                {c.fuel === "Xang" && "Xăng"} {c.fuel === "Dau" && "Dầu"}
                {c.fuel === "Dien" && "Điện"}
              </p>
            </div>
          </div>
