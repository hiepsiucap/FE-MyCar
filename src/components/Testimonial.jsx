...
const Testimonial = () => {
  return (
    <section className=" md:container mx-auto">
      <h1 className=" text-4xl py-24 font-bold font-manrope">
        Đánh giá khách hàng
      </h1>
      <div className=" flex space-x-5">
        ...
        >
          ...
          <p className=" text-sm font-manrope h-28 text-start">
            Thời gian đặt xe linh động và không ràng buộc nhiều vấn đề khi đặt
            xe.
          </p>
