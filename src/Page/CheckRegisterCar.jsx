    ...
    >
      <div className=" justify-between flex items-center pb-5">
        ...
        <h1 className=" text-3xl font-manrope font-bold text-start pb-5">
          Duyệt thông tin xe
          <span className=" text-primary font-4xl">
            ({cardata?.totalElements})
          </span>
        </h1>{" "}
      </div>
            ...
            <>
              ...
              <div className=" p-5 pb-10 flex bg-white w-full rounded-lg shadow-sm">
                <div className=" w-3/4 flex  space-x-5 border-r-2 border-primary border-opacity-40 ">
                  ...
                  <div className=" flex flex-col space-y-2 w-full">
                    ...
                    <div className=" flex text-start items-end ">
                      <p className="text-gray-500 text-xs font-manrope pr-1">
                        Địa diểm:
                      </p>
                      <p className=" text-black text-sm font-manrope pr-2">
                        {car.location.address}, {car.location.district},{" "}
                        {car.location.province}
                      </p>
                    </div>
                    <div className=" flex text-start  items-end">
                      <p className="text-gray-500 text-xs font-manrope pr-1">
                ...
                <div className=" flex flex-col justify-center items-center w-1/4 space-y-2.5">
                  <button
                    id={car.carId}
                    className=" p-2 px-6 border w-44 border-primary hover:bg-primary hover:text-white rounded-md font-manrope  text-sm font-medium"
                    onClick={(e) => {
                  ...
                  <button
                    id={car.carId}
                    className=" p-2 px-8 w-44 border border-primary hover:bg-primary hover:text-white rounded-md font-manrope  text-sm font-medium"
                  ...
                  <button
                    id={car.carId}
                    to="/calendar/12"
                    className=" w-44 p-2 px-9 border hover:bg-primary hover:text-white border-primary rounded-md font-manrope  text-sm font-medium"
